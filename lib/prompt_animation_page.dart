...
class PromptAnimationPage extends StatelessWidget {
  const PromptAnimationPage({super.key});

  static const String route = '/prompt-animation';
    ...
    return Scaffold(
      ...
      body: const Center(
        child: AnimatedPrompt(
          ...
          subtitle: 'Your order wil be delivered in 2 days. Enjoy!',
          child: Icon(
            Icons.check,
            color: Colors.white,
          ),
